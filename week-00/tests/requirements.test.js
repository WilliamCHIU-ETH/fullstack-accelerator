...
describe('W0 猜數字遊戲 — 核心功能', () => {
  ...
  it('輸入太高的數字時回應「太高」相關訊息', { skip: skipReason }, async () => {
  ...
  it('輸入太低的數字時回應「太低」相關訊息', { skip: skipReason }, async () => {
  ...
  it('輸入非數字時顯示錯誤提示且不計次數', { skip: skipReason }, async () => {
    const result = await runGame([
      'abc',
      '50',
      '50',
  ...
  it('超過最大次數時遊戲結束並顯示答案', { skip: skipReason }, async () => {
